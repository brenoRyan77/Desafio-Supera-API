...
@Repository
public interface TransaferenciaRepository extends JpaRepository<Transferencia, Long>{

	@Query("SELECT t FROM Transferencia t WHERE " + "(:dataInicio IS NULL OR t.dataTransferencia >= :dataInicio) AND "
